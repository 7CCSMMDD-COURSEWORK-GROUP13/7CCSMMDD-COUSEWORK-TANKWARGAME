 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.mdd.cf.tankwar.tankWar.impl.WallObstacleImpl#getWallWidth <em>Wall Width</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdd.cf.tankwar.tankWar.impl.WallObstacleImpl#getWallHeight <em>Wall Height</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdd.cf.tankwar.tankWar.impl.WallObstacleImpl#getWallPosX <em>Wall Pos X</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.mdd.cf.tankwar.tankWar.impl.WallObstacleImpl#getWallPosY <em>Wall Pos Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WallObstacleImpl extends ObstacleMemberImpl implements WallObstacle
{
  ...
  {
    return TankWarPackage.Literals.WALL_OBSTACLE;
  }
  ...
  public void setWallWidth(int newWallWidth)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TankWarPackage.WALL_OBSTACLE__WALL_WIDTH, oldWallWidth, wallWidth));
  }
  ...
  public void setWallHeight(int newWallHeight)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TankWarPackage.WALL_OBSTACLE__WALL_HEIGHT, oldWallHeight, wallHeight));
  }
  ...
  public void setWallPosX(int newWallPosX)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TankWarPackage.WALL_OBSTACLE__WALL_POS_X, oldWallPosX, wallPosX));
  }
  ...
  public void setWallPosY(int newWallPosY)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TankWarPackage.WALL_OBSTACLE__WALL_POS_Y, oldWallPosY, wallPosY));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TankWarPackage.WALL_OBSTACLE__WALL_WIDTH:
        return getWallWidth();
      case TankWarPackage.WALL_OBSTACLE__WALL_HEIGHT:
        return getWallHeight();
      case TankWarPackage.WALL_OBSTACLE__WALL_POS_X:
        return getWallPosX();
      case TankWarPackage.WALL_OBSTACLE__WALL_POS_Y:
        return getWallPosY();
    }
